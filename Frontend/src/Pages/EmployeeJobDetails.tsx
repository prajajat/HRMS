...
function EmployeeJobDetails() {
  ...
  const { mutate: createReferral, isPending: isReferralLoading } =
    useCreateJobReferral();
          ...
          <div className="max-w-4xl">
            ...
            <div className="bg-gray-100 rounded-lg p-6 mb-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Button onClick={() => setActiveAction("view")}>
                  View Details
                </Button>

                <Button onClick={() => setActiveAction("referral")}>
                  Make Referral
                </Button>
            ...
            {activeAction === "referral" && (
              <div className="bg-gray-100 rounded-lg p-6">
                ...
                <form
                  onSubmit={handleSubmit(handleCreateReferral)}
                  className="space-y-4"
                >
                  <TextField
                    label="friend name"
                  ...
                  <div>
                    ...
                    />
                    {cvFile && <p className="mt-2">Selected: {cvFile.name}</p>}
                  </div>

                  <div className="flex gap-3 pt-4">
                    <Button type="submit" disabled={isReferralLoading}>
            ...
            {activeAction === "share" && (
              <div className="bg-gray-100 rounded-lg p-6">
                ...
                <form
                  onSubmit={handleSubmit(handleShareJob)}
                  className="space-y-4"
                >
                  <TextField
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button type="submit" disabled={isShareLoading}>
