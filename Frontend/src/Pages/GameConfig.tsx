          ...
          <FormControl>
            ...
            <Input
              ...
              {...register("slotDurationMinutes", {
                ...
                min: {
                  value: 0,
                  message: " slot Duration Minutes must be positive",
                },
              })}
            />
          </FormControl>
          ...
          <FormControl>
            ...
            <Input
              ...
              {...register("maxPlayerPerSlot", {
                ...
                min: {
                  value: 0,
                  message: " max Player Per Slot must be positive",
                },
              })}
            />
          </FormControl>
          ...
          <FormControl>
            ...
            <Input
              ...
              {...register("maxSlotPerBooking", {
                ...
                min: {
                  value: 0,
                  message: " max Slot Per Booking must be positive",
                },
              })}
            />
          </FormControl>
          ...
          <FormControl>
            ...
            <Input
              ...
              {...register("maxDayOfBookingAllow", {
                ...
                min: {
                  value: 0,
                  message: " max Day Of Booking Allow must be positive",
                },
              })}
            />
          </FormControl>
